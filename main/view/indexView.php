<h2 class="mt-3 d-flex justify-content-center cloisterBlack" style="font-size;">Catalogue</h2>
...
<div class="card" style="width: 10rem;">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item"><input type="radio" value="Poésie" name="category">
    <label for="Poésie">Poésie</label></li>
